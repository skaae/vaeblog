...
Below we show images generated by the VAE-GAN models. We still see some smootig and the reconstruction are not perfect, but we also see some intersting interpolation e.g. removing sun glasses and objects in front of faces. 
